...
The details of the request format and the lifecycle of a request can be seen in the follwoing diagram:

![request lifecycle](./substraTEE_request_format_end2end.svg)
